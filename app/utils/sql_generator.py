...
class SQLQueryGenerator:
    ...
    def _optimize_query(self, sql: str) -> str:
        ...
        # LLMs often add ::geography casting which bypasses spatial indexes (extremely slow).
        # Strip ::geography so queries use the faster geom_25833 projected column.

        # 1. Strip ::geography casting
        sql = re.sub(r'::\s*geography\b', '', sql, flags=re.IGNORECASE)

        # 2. Remove unnecessary ST_Transform in certain contexts
        ...
        # 3. Fix osm_id datatype mismatches in UNION queries
