...
class WeightCalculator:
    ...
    CONTEXT_WEIGHTS = {
        ...
        'restaurant': {
            ...
            'alkis_buildings': 0.20,         # Residential density - positive (use filter)
        ...
        'cafe': {
            ...
            'alkis_buildings': 0.25,         # Office workers (COMMERCIAL filter)
